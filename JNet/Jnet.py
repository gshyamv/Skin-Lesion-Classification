...
def train_model(
    ...
    This version does NOT early stop; it always runs 'num_epochs'.
    """
    ...
    for epoch in range(num_epochs):
        ...
        # Save "best model" checkpoint if it improves on val loss
        ...
        # Save checkpoint every 10 epochs or at last epoch
