...
class SkinLesionDataset(Dataset):
    ...
    Expects:
      ...
      - Images are located in a single directory.
    ...
    def find_image_file(self, image_id):
        """Search for the image file in the given directory."""
...
class UnifiedJNet(nn.Module):
    ...
    def __init__(self, num_classes=7, base_channels=64):
        ...
        # Multi-stage decoder for sharper masks
...
# -------------------------------------------------------------------------
# Utility to save binary segmentations for entire dataset
# -------------------------------------------------------------------------
...
# -------------------------------------------------------------------------
# Utility to save color overlay segmentation for entire dataset
# -------------------------------------------------------------------------
...
# -------------------------------------------------------------------------
# Utility to visualize segmentation results on random samples
# -------------------------------------------------------------------------
...
def main():
    try:
        ...
        # Optional: save segmentations on the test dataset
